...
# import json
# import numpy as np
# from ..core import default_graph, Variable, get_node_from_graph, Node
# from ..utils import ClassMining


# class Saver(object):
#     """
#     Save model as graph and weights.
#     """
...
#         meta = {} if meta is None else meta # meta info
...
#             # if thie node in graph: assign weights, else create new node and assign weights
...
#                 parent_node = create_node(graph, from_model_json, parent_node_json)
